Description: For author name generation of the task 3, I have created the python file titled name_generation.ipython based on the the dataset titled author_name.csv to generate the result dataset named names.txt.
